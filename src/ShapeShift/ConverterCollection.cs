...
{
	private ConverterCollection(FrozenDictionary<Type, ShapeShiftConverter<TEncoder, TDecoder> map)
	{
		this.Map = map;
	}
	...
	public static ConverterCollection Create(ReadOnlySpan<ShapeShiftConverter<TEncoder, TDecoder> converters)
	{
