...
internal class ObjectConverter<T, TEncoder, TDecoder> : IConverter<T, TEncoder, TDecoder>
    ...
    where TDecoder : IDecoder, allows ref struct
{
    ...
    public T? Read(ref TDecoder decoder, SerializationContext context)
    {
    ...
    public void Write(ref TEncoder encoder, in T? value, SerializationContext context)
    {
        if (value is null)
        {
            encoder.WriteNull();
