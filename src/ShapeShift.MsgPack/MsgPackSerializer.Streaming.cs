...
public sealed partial record MsgPackSerializer
{
	...
	/// <inheritdoc cref="SerializeAllAsync{T}(PipeWriter, IAsyncEnumerable{T}, CancellationToken)"/>
	public ValueTask SerializeAllAsync<T>(PipeWriter writer, IEnumerable<T?> values, CancellationToken cancellationToken = default)
		where T : IShapeable<T> => this.SerializeAllAsync<T, T>(writer, values, cancellationToken);

	/// <inheritdoc cref="SerializeAllAsync{T, TProvider}(PipeWriter, IAsyncEnumerable{T}, CancellationToken)"/>
	...
	/// <param name="values"><inheritdoc cref="SerializeAllAsync{T}(PipeWriter, IAsyncEnumerable{T}, CancellationToken)" path="/param[@name='values']"/></param>
	/// <param name="cancellationToken">A cancellation token.</param>
	...
	/// <inheritdoc cref="SerializeAllAsync{T, TProvider}(PipeWriter, IAsyncEnumerable{T}, CancellationToken)"/>
	/// <param name="stream">The destination stream. It is not closed or disposed by this method.</param>
	/// <param name="values"><inheritdoc cref="SerializeAllAsync{T, TProvider}(PipeWriter, IAsyncEnumerable{T}, CancellationToken)" path="/param[@name='values']"/></param>
	/// <param name="cancellationToken">A cancellation token.</param>
	...
	/// <inheritdoc cref="DeserializeAllAsync{T}(Stream, long, CancellationToken)"/>
	/// <typeparam name="T">The type of each top-level value.</typeparam>
	/// <typeparam name="TProvider">The type shape provider.</typeparam>
	...
	/// <inheritdoc cref="SerializeFrameAsync{T}(PipeWriter, T, CancellationToken)"/>
	/// <typeparam name="T">The value type.</typeparam>
	/// <typeparam name="TProvider">The type shape provider.</typeparam>
	...
	/// <inheritdoc cref="SerializeFrameAsync{T, TProvider}(PipeWriter, T, CancellationToken)"/>
	/// <param name="stream">The destination stream. It is not closed or disposed by this method.</param>
	/// <param name="value">The value to serialize.</param>
	/// <param name="cancellationToken">A cancellation token.</param>
	...
	/// <inheritdoc cref="DeserializeFrameAsync{T}(PipeReader, long, CancellationToken)"/>
	/// <typeparam name="T">The value type.</typeparam>
	/// <typeparam name="TProvider">The type shape provider.</typeparam>
	...
	/// <inheritdoc cref="DeserializeFrameAsync{T, TProvider}(PipeReader, long, CancellationToken)"/>
	/// <param name="stream">The source stream. It is not closed or disposed by this method.</param>
	/// <param name="maxFrameLength">The largest frame this call will accept, checked against the length prefix before any of the frame is buffered.</param>
	/// <param name="cancellationToken">A cancellation token.</param>
	...
	/// <inheritdoc cref="DeserializeAllFramesAsync{T}(PipeReader, long, CancellationToken)"/>
	/// <typeparam name="T">The type of each framed value.</typeparam>
	/// <typeparam name="TProvider">The type shape provider.</typeparam>
	...
	/// <inheritdoc cref="DeserializeAllFramesAsync{T, TProvider}(PipeReader, long, CancellationToken)"/>
	/// <param name="stream">The source stream. It is not closed or disposed by this method.</param>
	/// <param name="maxFrameLength">The largest frame this call will accept, checked against each length prefix before any of that frame is buffered.</param>
	/// <param name="cancellationToken">A cancellation token that applies throughout the enumeration.</param>
	...
	/// or <c>Found</c> is <see langword="false" /> when the path is not present in the value that was read.
	/// </returns>
	...
	/// <inheritdoc cref="TryDeserializeFragmentAsync{T}(PipeReader, ShapeShiftPath, long, CancellationToken)"/>
	/// <typeparam name="T">The type to deserialize the fragment as.</typeparam>
	/// <typeparam name="TProvider">The type shape provider.</typeparam>
	...
	/// <param name="stream">The source stream. It is not closed or disposed by this method.</param>
	/// <param name="path">The location, within the next top-level value, of the value to deserialize.</param>
	/// <param name="maxBufferedSize">The maximum number of bytes to buffer while searching for the enclosing top-level value's end.</param>
	/// <param name="cancellationToken">A cancellation token.</param>
	...
	/// <inheritdoc cref="TryDeserializeFragmentAsync{T, TProvider}(PipeReader, ShapeShiftPath, long, CancellationToken)"/>
	/// <param name="stream">The source stream. It is not closed or disposed by this method.</param>
	/// <param name="path">The location, within the next top-level value, of the value to deserialize.</param>
	/// <param name="maxBufferedSize">The maximum number of bytes to buffer while searching for the enclosing top-level value's end.</param>
	/// <param name="cancellationToken">A cancellation token.</param>
